...
// by TTYMan
//
// para compilar:  nvcc ParallelEngine.cu -o ParallelEngine -I/home/ttyman/NVIDIA_GPU_Computing_SDK/C/common/inc
...
int main(int argc, char **argv)
{
    ...
    // discrete variables
    char    Arquivo[] = "./data/sphere25k.ini";
    int     N = 0;
    ...
    float dtout = 0.1f;   // indicates the value of the step where a result file has to be generated.
    float tout = t+dtout;
    int    timeSteps = 100; //WARNING!! Don't forget to update this value with the desired time steps amount!
    float epson = 0.0f;
